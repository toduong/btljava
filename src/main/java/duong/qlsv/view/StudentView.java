...
public class StudentView extends JFrame implements ActionListener, ListSelectionListener {
    ...
    private void initComponents() {
        ...
        search = new JButton("Tim kiem");
        
        jScrollPaneStudentTable = new JScrollPane();
        studentTable = new JTable();
        
        searchLabel = new JLabel("Tim kiem");
        ...
        layout.putConstraint(SpringLayout.NORTH, search, 300, SpringLayout.NORTH, panel);
